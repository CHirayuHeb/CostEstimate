...
namespace CostEstimate.Controllers.AddOProcessWK
{
    public class AddOProcessWKController : Controller
    {
        private LAMP _LAMP;
        private HRMS _HRMS;
        private IT _IT;
        ...
        public AddOProcessWKController(LAMP lamp, HRMS hrms, IT it, MK mk, MOLD mold, CacheSettingController cacheController, FunctionsController callfunction)
        {
            _LAMP = lamp;
            _HRMS = hrms;
            _IT = it;
        ...
        public ActionResult DeleteMasterProcess(int mpNo)
        {
            ...
            {
                //cerunCostPalnning
                ViewceMastProcess vRun = _MK._ViewceMastProcess.Where(x => x.mpNo == mpNo && x.mpType == "MoldOtherWK").FirstOrDefault();
                if (vRun != null)
                {
        ...
        public PartialViewResult SearchMastProcess(int mpNo, Class @class)
        {
            ...
            return PartialView("_PartialMastOProcessWK", @class);
        ...
        public ActionResult AddMasterProcess(Class @class)
        {
            ...
            string[] vRunCostNo;
            string[] vSaveCost;
            string msg = "Save Master Mold Other Process Woking  success!!";
