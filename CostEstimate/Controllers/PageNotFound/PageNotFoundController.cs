...
namespace CostEstimate.Controllers._404
{
    public class PageNotFoundController : Controller
    {
        ...
        public PageNotFoundController(LAMP lamp, HRMS hrms, IT it, MK mk, MOLD mold, CacheSettingController cacheController, FunctionsController callfunction)
        {
            _LAMP = lamp;
            _HRMS = hrms;
            _IT = it;
