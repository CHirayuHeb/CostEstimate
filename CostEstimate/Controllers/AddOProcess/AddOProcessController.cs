...
namespace CostEstimate.Controllers.AddOProcess
{
    public class AddOProcessController : Controller
    {
        private LAMP _LAMP;
        private HRMS _HRMS;
        private IT _IT;
        ...
        public AddOProcessController(LAMP lamp, HRMS hrms, IT it, MK mk, MOLD mold, CacheSettingController cacheController, FunctionsController callfunction)
        {
            _LAMP = lamp;
            _HRMS = hrms;
            _IT = it;
        ...
        public IActionResult Index(Class @class)
        {
            ...
            @class._ListceMastProcess = _MK._ViewceMastProcess.Where(x => x.mpType == "MoldOther").OrderBy(z => z.mpGroupName.Trim()).ToList();
        ...
        public PartialViewResult SearchMastProcess(int mpNo, Class @class)
        {
            ...
            return PartialView("_PartialMastOProcess", @class);
        ...
        public ActionResult AddMasterProcess(Class @class)
        {
            ...
            string[] vRunCostNo;
            string[] vSaveCost;
            string msg = "Save Master Mold Other Process success!!";
                ...
                try
                {
                    if (@class._ViewceMastProcess.mpNo > 0)
                    {
                        ...
                        if (_viewceMastProcess != null)
                        {
                            ...
                            _viewceMastProcess.mpType = "MoldOther";
