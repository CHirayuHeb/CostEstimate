    ...
    public class NewMoldOtherTGRController : Controller
    {
        ...
        public ActionResult SendMail(Class @class, int s_step, string s_issue, string mpNo)
        {
           ...
           //string v_listemailTo;
            ...
            string v_empCodeCC = _MK._ViewceMastFlowApprove.Where(x => x.mfStep == s_step && x.mfFlowNo == "6") != null ? _MK._ViewceMastFlowApprove.Where(x => x.mfStep == s_step && x.mfFlowNo == "6").Select(x => x.mfCC).FirstOrDefault() : "";
