...
namespace CostEstimate.Controllers.AddOModel
{
    public class AddOModelController : Controller
    {
        private LAMP _LAMP;
        private HRMS _HRMS;
        private IT _IT;
        ...
        public AddOModelController(LAMP lamp, HRMS hrms, IT it, MK mk, MOLD mold, CacheSettingController cacheController, FunctionsController callfunction)
        {
            _LAMP = lamp;
            _HRMS = hrms;
            _IT = it;
        ...
        public PartialViewResult SearchMastModel(int mmNo, string ModelName, Class @class)
        {
            try
            {
                ...
                {
                    @class._ViewceMastModel = _MK._ViewceMastModel.Where(x => x.mmNo == mmNo && x.mmModelName == ModelName && x.mmType == "MoldOtherMaterial").FirstOrDefault();
            ...
            return PartialView("_PartialMastModel", @class);
        ...
        public ActionResult DeleteMasterModel(int mmNo, string ModelName)
        {
            ...
            {
                //cerunCostPalnning
                ViewceMastModel vRun = _MK._ViewceMastModel.Where(x => x.mmNo == mmNo && x.mmModelName == ModelName && x.mmType == "MoldOtherMaterial").FirstOrDefault();
                if (vRun != null)
                {
