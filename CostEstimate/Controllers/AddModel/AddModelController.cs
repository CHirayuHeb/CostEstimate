...
namespace CostEstimate.Controllers.AddModel
{
    public class AddModelController : Controller
    {
        ...
        public AddModelController(LAMP lamp, HRMS hrms, IT it, MK mk, MOLD mold, CacheSettingController cacheController, FunctionsController callfunction)
        {
            _LAMP = lamp;
            _HRMS = hrms;
            _IT = it;
        ...
        public ActionResult AddMasterModel(Class @class)
        {
            ...
            string[] vRunCostNo;
            string[] vSaveCost;
            string msg = "Save Master Model success!!";
