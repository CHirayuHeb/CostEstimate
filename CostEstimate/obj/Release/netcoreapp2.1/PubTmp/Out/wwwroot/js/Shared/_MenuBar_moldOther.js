...
//Mold Modify Other
var searchMoldO = document.querySelector("button.searchMoldOther");
var createMoldO = document.querySelector("button.createMoldOther");
var myRequestMoldO = document.querySelector("button.my-requestMoldOther");
var approvalMoldO = document.querySelector("button.approvalMoldOther");
var addMasterMoldO = document.querySelector("button.Master_addMoldOther");
...
function PositionY(menu) {
    ...
    switch (menu) {
        ...
        case "NewMoldOtherMT":  //MATERIAL
            ...
            opacity = "opacity-dot-3";
            break;
        case "NewMoldOtherSM":  //INFORMATION SPEC MOLD
            LoadScript("js/Home/Index.js", "Home");
            LoadScript("js/New/IndexMoldOther.js", "New");
